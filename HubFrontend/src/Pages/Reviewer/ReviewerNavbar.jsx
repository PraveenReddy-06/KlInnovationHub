...
const ReviewerNavbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 flex justify-between items-center px-4 sm:px-6 lg:px-12 h-16 lg:h-18 shadow-lg bg-primary">
      <button onClick={() => setMobileMenuOpen((prev) => !prev)} className="lg:hidden text-white text-2xl">
      ...
      <Link to="/reviewerDashboard" className="flex items-center gap-2 shrink-0">
        ...
        <div className="flex flex-col leading-none">
          ...
          <span className="hidden sm:block text-[10px] lg:text-[11px] tracking-widest uppercase text-tan">Innovate • Build • Launch</span>
        </div>
      </Link>
